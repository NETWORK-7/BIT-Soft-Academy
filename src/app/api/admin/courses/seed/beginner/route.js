...
const BEGINNER_LESSONS = {
  ...
  "JavaScript Fundamentals": [
    {
      title: "JavaScript Setup and First Code",
  ...
  "React for Beginners": [
    {
      title: "React Setup and First Component",
  ...
  "Python Programming Basics": [
    {
      ...
      content: "Install Python and write your first program. Learn the print function and see immediate results.",
      videoId: "rfscVS0vtbw",
      duration: 30
    },
    {
      title: "Variables and Basic Math",
      content: "Store and manipulate data. Learn variables, basic math operations, and string manipulation.",
      videoId: "DZwmZ8Usvnk",
      duration: 35
    },
    {
      title: "User Input and Strings",
      content: "Get input from users and work with text. Learn input() function and string methods.",
      videoId: "QXeEoD0pB3E",
      duration: 40
    },
    {
      title: "Lists and Loops",
      content: "Work with collections of data. Learn Python lists and how to loop through them efficiently.",
      videoId: "ohBxdw73EwM",
      duration: 45
    },
    {
      title: "Functions in Python",
      content: "Create reusable code blocks. Learn to define and call functions with parameters and return values.",
      videoId: "9Os0o3wzS_I",
      duration: 40
    },
    {
      title: "Building a Simple Calculator",
      content: "Create a working calculator program. Apply all concepts to build your first useful Python application.",
      videoId: "JRCJ6r2Jy9k",
      duration: 50
    }
  ]
...
export async function POST() {
  try {
    ...
    for (const course of createdCourses) {
      const lessons = BEGINNER_LESSONS[course.title] || [];
    ...
    return NextResponse.json({
      success: true,
      message: `Successfully created ${createdCourses.length} beginner courses with ${totalLessonsCreated} lessons`,
      courses: createdCourses.length,
      lessons: totalLessonsCreated
    });

  } catch (error) {
    console.error("Error seeding beginner courses:", error);
